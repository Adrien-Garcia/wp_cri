...
UPDATE cri_posts SET guid = replace(guid, 'https://www.cridon-lyon.fr','http://${SERVER_NAME}');
...
UPDATE cri_posts SET post_content = replace(post_content, 'https://www.cridon-lyon.fr', 'http://${SERVER_NAME}');
UPDATE cri_postmeta SET meta_value = replace(meta_value, 'https://www.cridon-lyon.fr', 'http://${SERVER_NAME}');
...
UPDATE cri_posts SET post_content = REPLACE(post_content,'https://images.cridon-lyon.fr/wp-content/uploads','http://${SERVER_NAME}/wp-content/uploads');
UPDATE cri_posts SET guid = REPLACE(guid,'http://images.cridon-lyon.fr/wp-content/uploads','http://${SERVER_NAME}/wp-content/uploads');
UPDATE cri_posts SET guid = REPLACE(guid,'https://images.cridon-lyon.fr/wp-content/uploads','http://${SERVER_NAME}/wp-content/uploads');
EOM
