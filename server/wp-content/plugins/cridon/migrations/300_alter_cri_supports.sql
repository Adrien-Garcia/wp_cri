...
ALTER TABLE `cri_support` ADD COLUMN IF NOT EXISTS `icon` VARCHAR(64) DEFAULT NULL;
ALTER TABLE `cri_support` ADD COLUMN IF NOT EXISTS `document` VARCHAR(256) DEFAULT NULL;
