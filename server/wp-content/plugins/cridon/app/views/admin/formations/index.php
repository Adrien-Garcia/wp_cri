...
<?php if (get_option('cridon_next_year_catalog_published') == 0): ?>
    ...
    <br>
    <form action="<?php echo mvc_admin_url(array('controller' => 'formations', 'action' => 'publishnextyearcatalog')) ?>" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir publier le catalogue des formations <?php echo $nextYear ?> ?');">
