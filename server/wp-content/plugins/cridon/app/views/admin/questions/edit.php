...
<?php echo $this->form->has_many_dropdown('Competence', $aCompetence, array('select_id'=>'competence_select_n','select_name'=>'competence_select_n','label'=> 'Autres compétences','style' => 'width: 200px;', 'empty' => true)); ?>
