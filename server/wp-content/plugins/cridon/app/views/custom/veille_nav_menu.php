                    ...
                    <?php
                        ...
                        ?>
                            <li>
                                ...
                                <input type="hidden" class="menu-item-url" name="menu-item[<?php echo $i; ?>][menu-item-url]" value="<?php echo mvc_public_url(array('controller' => 'veilles','action'=>'show','id' => $item->post->post_name)) ?>">
                            </li>
                    <?php
                        endforeach;
                    ?>
