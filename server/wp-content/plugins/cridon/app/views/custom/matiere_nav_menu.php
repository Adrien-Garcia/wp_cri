    ...
    <div id="tabs-panel-wishlist-matiere_nav_menu" class="tabs-panel tabs-panel-active">
        <ul id ="wishlist-matiere_nav_menu-checklist" class="categorychecklist form-no-clear">
            ...
            <li>
                ...
                <input type="hidden" class="menu-item-url" name="menu-item[<?php echo $i; ?>][menu-item-url]" value="<?php echo mvc_public_url(array('controller' => 'matieres', 'id' => $item->virtual_name)) ?>">
            </li>
            <?php endforeach; ?>
        </ul>
    </div>
