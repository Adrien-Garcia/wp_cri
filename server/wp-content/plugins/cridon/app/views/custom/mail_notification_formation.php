...
<head>
    ...
    <style type="text/css">
        ...
        h1 {color:#009999; font-weight:normal; font-size:28px; text-transform:uppercase; line-height:30px; margin:15px 0px 5px 0px; padding:0px; font-family:'Dosis', Arial, Helvetica, sans-serif;}
...
<div align="center" style="width:100%; background-color:#e6e6e6; padding:15px 0px; color:#2e4867;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="background-color:#fff; color:#2e4867; margin:auto; line-height:18px;" width="600">
        ...
        <tr>
            ...
            <u>Thématique</u> : <span class="section">DROIT SOCIAL</span> <br />
            ...
            <span class="introduction">Vous serez prochainement recontacté par le CRIDON LYON pour finaliser votre inscription à la cession choisie ci-dessous :</span>
            <br /><br /><br />
