...
/**
 * Description of cridon.cahierparser.lib.php
 *
 * @package wp_cridon
 * @author eTech
 * @contributor Joelio
 */
class CridonCahierParser extends parseCSV
{

    /**
     * @var int : offset of id in Output data
     */
    const CAHIER_ID  = 0;

    /**
     * @var int : offset of title in Output data
     */
    const CAHIER_TITLE     = 1;

    /**
     * @var int : offset of date in Output data
     */
    const CAHIER_DATE   = 2;

    /**
     * @var int : offset of pdf_file in Output data
     */
    const CAHIER_PDF    = 3;

    /**
     * @var int : offset of parent_id in Output data
     */
    const CAHIER_PARENTID    = 4;

    /**
     * @var int : offset of parent_title in Output data
     */
    const CAHIER_PARENTTITLE = 5;

    /**
     * @var int : offset of parent_date in Output data
     */
    const CAHIER_PARENTDATE   = 6;

    /**
     * @var int : offset of matiere_id in Output data
     */
    const CAHIER_MATIEREID = 7;
