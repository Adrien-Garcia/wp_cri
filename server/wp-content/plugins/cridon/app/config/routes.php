...
MvcRouter::public_connect('calendrier-des-formations/{:year:(\d\d\d\d)}/{:month:((0[1-9])|(1[0-2]))}', array('controller' => 'formations', 'action' => 'calendar'));
MvcRouter::public_connect('calendrier-des-formations', array('controller' => 'formations', 'action' => 'calendar_now'));
