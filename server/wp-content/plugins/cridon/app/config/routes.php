...
MvcRouter::public_connect('notaires/setpromo', array('controller' => 'notaires', 'action' => 'ajaxsetpromo'));
...
MvcRouter::public_connect('catalogue', array('controller' => 'formations', 'action' => 'oldcatalog'));
