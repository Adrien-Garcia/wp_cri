...
class AdminMatiereHelper extends MvcHelper
{
    /*
     * @override
     */
    public function admin_actions_cell($controller, $object)
    {
        ...
        $links[] = '<a href="'.MvcRouter::public_url(array('object' => $object, 'id'=> $object->virtual_name)).'" title="'.Config::$actionsWpmvcTranslation['view'].' '.$encoded_object_name.'">'.Config::$actionsWpmvcTranslation['view'].'</a>';
