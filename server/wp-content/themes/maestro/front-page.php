   			...
   			<div id="inner-content" class="wrap cf">
   				...
   				<div class="details">
   					<div id="accordion-juridique" class="accordion js-tab-veille open">
					    ...
					    <a href="<?php echo MvcRouter::public_url(array('controller' => 'veilles', 'action'     => 'resetCriteria')) ?>" id="sel-hp-veilles-link" title=""><span><?php _e('Toute la veille juridique'); ?></span></a>
