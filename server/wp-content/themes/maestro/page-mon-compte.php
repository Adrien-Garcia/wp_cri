		...
		<div id="main" class="cf" role="main">
			...
			<div id="inner-content" class="wrap cf">
				...
				<ul id="sel-compte">
                    ...
                    ?>
                    <li class="js-account-collaborateur js-account-blocs <?php echo ($onglet == 6) ? " active " : ""?>" data-js-name="Collaborateur" data-js-ajax-src="<?php get_home_url() ?>/notaires/contentcollaborateur">
                        <a href="<?php get_home_url() ?>/notaires/collaborateur" class="bt js-account-collaborateur-button" id="sel-compte-collaborateur-button">Mes collaborateurs</a>
